let taskAPI = "https://da-join-ca344-default-rtdb.europe-west1.firebasedatabase.app/demoUser/users/user1ID/notes";
let contactAPI = "https://da-join-ca344-default-rtdb.europe-west1.firebasedatabase.app/demoUser/users/user1ID/contacts";
...
async function deleteTask(taskKey) {
    const deleteAPI = `https://da-join-ca344-default-rtdb.europe-west1.firebasedatabase.app/demoUser/users/user1ID/notes/${taskKey}.json`;
